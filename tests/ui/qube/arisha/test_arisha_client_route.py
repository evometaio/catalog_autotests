...
@pytest.mark.ui
def test_arisha_send_callback_form_on_client_page(arisha_client_page):
    """Тест отправки формы обратной связи на клиентской странице проекта Arisha."""
    with allure.step("Открываем клиентскую страницу проекта Arisha"):
        arisha_client_page.open_client_page()

        current_url = arisha_client_page.get_current_url()
