...
MOBILE_APARTMENT_SELECTOR = '//span[contains(text(), "VIEW APARTMENT")]'  # Селектор для apartments
MOBILE_APARTMENT_LOCK_ICON = 'span[aria-label="lock"]'  # Иконка замка для заблокированных apartments
