...
class MarkLocators(BaseLocators):
    ...
    # Навигация
    NAV_DESKTOP_CATALOG2D_STANDALONE = '[data-test-id="nav-desktop-catalog2d-standalone"]'
    ...
    AREA_TOUR_360_MENU_ROTATION = '[data-test-id="nav-rotation-view-controls-menu-rotation"]'
    AREA_TOUR_360_MENU_TOUR_YARD = '[data-test-id="nav-rotation-view-controls-menu-tour-yard"]'
    AREA_TOUR_360_MENU_TOUR_LOBBY_K1 = '[data-test-id="nav-rotation-view-controls-menu-tour-lobby-k1"]'
    AREA_TOUR_360_MENU_TOUR_LOBBY_K2 = '[data-test-id="nav-rotation-view-controls-menu-tour-lobby-k2"]'
    AREA_TOUR_360_MENU_TOUR_LOBBY_K3 = '[data-test-id="nav-rotation-view-controls-menu-tour-lobby-k3"]'
    ...
    AREA_TOUR_360_MODAL = '[data-test-id="rotation-view-360-modal"], .ant-modal-content, [role="dialog"]'
    ...
    AREA_TOUR_360_CONTENT = '[data-test-id="rotation-view-360-content"] img, iframe, canvas, video'
    ...
    class ApartmentWidget:
        ...
        SCENE_INDICATOR = 'xpath=(//div[contains(@class, "widget-arrow-controls__text")])[2]'
